...
var getSummarystats = function (data) {
    ...
    if (stats.classes.count) {
        stats.classes.unusedPercentage = ((stats.classes.unusedCount / stats.classes.count) * 100).toFixed(2);
        stats.classes.avgUsage = (stats.classes.totalUsage / stats.classes.usedCount).toFixed(2);
    }

    if (stats.selectors.count) {
        stats.selectors.avgLength = (stats.selectors.totalLength / stats.selectors.count).toFixed(2);
    }
